...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'catalog/ourfeedbacks')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_ourfeedbacks'),
					'href'     => $this->url->link('catalog/ourfeedbacks', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
