            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php } else { ?>
                    <td class="left"><?php echo $feedback['name']; ?><?php echo $feedback['name']; ?></td>
                  <?php } ?>
                  <td class="text-right"><?php echo $feedback['description']; ?></td>
                  <td class="text-right"><a href="/admin/index.php?route=catalog/ourfeedbacks/edit&token=la5n09zNbZJn01QKpPCMrhh2IF72L3om&feedback_id=<?php echo $feedback['id']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
